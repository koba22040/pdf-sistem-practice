    ...
    try {
        ...
        for (const fieldId in state.fieldPositions) {
            ...
            if (type === 'textarea') {
                ...
                firstPage.drawText(symbol, { x: centeredX, y: centeredY, size: checkFontSize, font: customFont, color: rgb(0, 0, 0) });
            }
        }
